...
describe("isSupportedMarketplacePage", () => {
  it("accepts supported joongna and bunjang product or chat pages", () => {
    ...
    expect(isSupportedMarketplacePage("http://203.0.113.10:3000/product/227242032.html")).toBe(true);
    expect(isSupportedMarketplacePage("http://203.0.113.10:3000/joongna-chat.html")).toBe(true);
    expect(isSupportedMarketplacePage("http://203.0.113.10:3000/bunjang-chat.html")).toBe(true);
  ...
  it("rejects unrelated pages", () => {
    ...
    expect(isSupportedMarketplacePage("http://203.0.113.10:3000/")).toBe(false);
  });
});
